/**
 * Web search: the Codex-native provider tool, and the DuckDuckGo HTML fallback with the same result format.
 *
...
/** Formats one search block; bounded to MAX_OUTPUT_CHARS including the reminder. */
