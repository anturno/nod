/** Text and JSON output of `nod workspace …`, byte-for-byte what fx prints. */
import { MAX_ADDITIONAL_DIRECTORIES } from "./access.ts";
import type { WorkspaceResult } from "./commands.ts";

// ponytail: control characters become U+FFFD; fx also escapes invalid UTF-8, which JS strings cannot carry.
