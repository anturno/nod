...
test("docs never mention fx-only features", () => {
  const banned = [/fx\.sh/, /Vercel/, /AI_GATEWAY/, /Exa\b/, /kimi/, /gemini/, /Herdr/, /keychain/i, /wasm/i, /FX_/];
...
test("llms-full.txt uses fx's frontmatter format with canonical and markdown urls", () => {
